                    ...
                    <div class="modal-body">
                        <div class="container-fluid">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-7">
                                    <input id="fechaNacEmpleado" type="date" class="form-control" max="{{Carbon\Carbon::now('-05:00')->subYears(18)->format('Y-m-d')}}" placeholder="Mes/Día/Año">
                                </div>
                            </div>
                            <div class="form-group row">
                            ...
                            <div class="div-img-center">
                                <img id="imgPreview" class="rounded-circle avatar-lg img-thumbnail img-preview img-preview-user" alt="empleado-image">
