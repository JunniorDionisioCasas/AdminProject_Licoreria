...
@section('js')
    ...
    <script>
        ...
        selectProvincia.onchange = function(){
            ...
            removeValidatedStyle('selectProvincia');
        ...
        $('#btnCrear').click(function (){
            ...
            $('#selectProvincia').removeAttr('required');
            $('#selectDistrito').removeAttr('required');
            removeOptions(selectDistrito);
        ...
        $("#formCliente").submit(function (e){
            ...
            if ( direccion ) {
                $('#selectProvincia').attr('required', 'required');
                $('#selectDistrito').attr('required', 'required');
                if ( !(idDistrito) ) {
                    if ( !(idProvincia) ) {
                        toastr.warning('Para guardar una dirección debe seleccionar una provincia y un distrito');
                        selectProvincia.classList.add("is-invalid");
                        selectProvincia.focus();
                        return false;
                    } else {
                        toastr.warning('Para guardar una dirección debe seleccionar un distrito');
                        selectProvincia.classList.add("is-invalid");
                        selectProvincia.focus();
                        return false;
                    }
